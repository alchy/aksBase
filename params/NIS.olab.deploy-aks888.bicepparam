...
param aksSubnetAddressPrefix = '10.1.0.0/24'                                  // Subnet pro nody AKS (pro jednotlive clustery jine subnety)
...
param sequence            = '888'                                             // Pořadové číslo, nebo nazev projektu
param tags                = {                                                 // Štítky
